# -*- coding: utf-8 -*
"""
A MongoDB Sage Notebook Datastore
...
class MongoDBDatastore(Datastore):
    def __init__(self, database, path):
        ...
        INPUT:
           ...
           - ``database`` -- pymongo.database.Database instance
    ...
    def load_server_conf(self):
        ...
        return self._basic_to_server_conf(self._db.conf.find_one())
    ...
    def load_openid(self):
        ...
        return self._db.openid.find_one()
    ...
    def load_users(self, user_manager):
        ...
        """
        from sagenb.notebook.user import User_from_basic
        for user_basic in self._db.users.find():
            user = User_from_basic(user_basic)
